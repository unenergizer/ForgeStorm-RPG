...
public class ChunkManager {
	...
	public ChunkManager(RPG plugin) {
		PLUGIN = plugin;
	...
	public void addNewChunk(Chunk chunk) {
		List<Integer> ids = PLUGIN.getMonsterSpawnerManager().assignSpawners(chunk);
		...
		if (!ids.isEmpty()) {
			...
			PLUGIN.getMonsterSpawnerManager().spawnMonsters(rpgChunk);
		}
	}
