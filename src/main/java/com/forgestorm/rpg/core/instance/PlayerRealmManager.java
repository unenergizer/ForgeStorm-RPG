package com.forgestorm.rpg.core.instance;
...
import com.forgestorm.rpg.world.instance.PlayerRealm;
import com.forgestorm.rpg.world.instance.PlayerRealmData;
...
public class PlayerRealmManager {
	...
	public PlayerRealmManager(RPG plugin) {
		PLUGIN = plugin;
