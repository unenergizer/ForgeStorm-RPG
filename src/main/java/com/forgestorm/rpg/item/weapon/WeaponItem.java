package com.forgestorm.rpg.item.weapon;
...
import com.forgestorm.rpg.item.Item;
import com.forgestorm.rpg.item.ItemQuality;
import com.forgestorm.rpg.item.ItemText;
...
public abstract class WeaponItem extends Item {
	...
	public WeaponItem(ItemQuality quality) {
		super(quality);
	}

	public ArrayList<String> generateWeaponLore() {
	...
	protected int damageGen(int min, int max) {
