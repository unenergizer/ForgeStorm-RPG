...
import com.forgestorm.rpg.item.armor.T1Boots;
import com.forgestorm.rpg.item.armor.T1Chestplate;
import com.forgestorm.rpg.item.armor.T1Helmet;
import com.forgestorm.rpg.item.armor.T1Leggings;
import com.forgestorm.rpg.item.armor.T2Boots;
import com.forgestorm.rpg.item.armor.T2Chestplate;
import com.forgestorm.rpg.item.armor.T2Helmet;
import com.forgestorm.rpg.item.armor.T2Leggings;
import com.forgestorm.rpg.item.armor.T3Boots;
import com.forgestorm.rpg.item.armor.T3Chestplate;
import com.forgestorm.rpg.item.armor.T3Helmet;
import com.forgestorm.rpg.item.armor.T3Leggings;
import com.forgestorm.rpg.item.armor.T4Boots;
import com.forgestorm.rpg.item.armor.T4Chestplate;
import com.forgestorm.rpg.item.armor.T4Helmet;
import com.forgestorm.rpg.item.armor.T4Leggings;
import com.forgestorm.rpg.item.armor.T5Boots;
import com.forgestorm.rpg.item.armor.T5Chestplate;
import com.forgestorm.rpg.item.armor.T5Helmet;
import com.forgestorm.rpg.item.armor.T5Leggings;
import com.forgestorm.rpg.item.weapon.T1Sword;
import com.forgestorm.rpg.item.weapon.T2Sword;
import com.forgestorm.rpg.item.weapon.T3Sword;
import com.forgestorm.rpg.item.weapon.T4Sword;
import com.forgestorm.rpg.item.weapon.T5Sword;
